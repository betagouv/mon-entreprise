...
export default function Accessibilité() {
	return (
		<Trans i18nKey="pages.accessibilité">
			...
			<main>
				<Body>
					Cette page n'est pas une page d'aide, mais une déclaration de
					conformité au{' '}
					...
					sur le site conformément à la réglementation. Cette page est
					obligatoire pour être conforme au RGAA 4.0.
				</Body>
				...
				<Ul>
					...
					<Li>
						Naviguer sans utiliser la souris, avec le clavier uniquement ou via
						un écran tactile.
					</Li>
				</Ul>
				<H2>Déclaration d’accessibilité</H2>
				<Body>
					L'Acoss s’engage à rendre ses sites internet accessibles conformément
				...
				<Body>
					Dans l’attente d’une mise en conformité totale, vous pouvez obtenir
					une version accessible des documents ou des informations qui y
					seraient contenues en envoyant un courriel à{' '}
					...
					en indiquant le nom du document concerné et/ou les informations que
					vous souhaiteriez obtenir. Les informations demandées vous seront
					transmises dans les meilleurs délais.
				</Body>
