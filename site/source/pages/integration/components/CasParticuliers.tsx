...
export function CasParticuliers() {
	const engine = useEngineFromModèle('modele-social')
			...
			<Trans i18nKey="pages.développeur.components.CasParticuliers">
				...
				<section>
					...
					<Body>
						...
						toutes les règles utilisées pour le calcul dont la valeur est
						absente dans la situation en entrée. C'est une{' '}
					...
					<Message icon>
						<Body>
							Le nombre qui leur est associé correspond à l'importance de la
							règle pour le calcul : plus il est élevé, plus la règle a été
							utilisée par d'autres règles lors du calcul.
						</Body>
					</Message>
				</section>
				...
				<section>
					...
					<Body>
						<Strong>
							Nous vous conseillons donc d'être très prudent dans l'utilisation
							de ces règles, et de toujours bien vérifier leur existence avant
							de les inclure dans votre code applicatif.
						</Strong>
					</Body>
				...
				<section>
					...
					<Body>
						Certaines données des simulateurs de mon-entreprise proviennent
						d'API externes. Il vous faudra ainsi récuperer leur valeur par
						vous-même pour la saisir dans la situation donnée en entrée.
					</Body>
