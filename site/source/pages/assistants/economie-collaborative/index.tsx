...
import { Body, Button } from '@/design-system/index'
...
export default function ÉconomieCollaborative() {
	...
	return (
		...
		>
			<Trans i18nKey="pages.assistants.economie-collaborative.texte">
				<Body>
				...
				<Button
					...
					title={t(
						'pages.assistants.economie-collaborative.aria-label',
