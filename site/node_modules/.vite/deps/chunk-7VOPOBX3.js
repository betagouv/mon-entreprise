...
function $1dbecbe27a04f9af$export$14d238f342723f25(defaultValue) {
  ...
  let valueRef = (0, import_react.useRef)(value);
  let effect = (0, import_react.useRef)(null);
  valueRef.current = value;
  let nextRef = (0, import_react.useRef)(null);
  nextRef.current = () => {
  ...
  let queue = (0, import_react.useCallback)((fn) => {
...
function $bdb11010cef70236$export$f680877a34711e37(defaultId) {
  ...
  let updateValue = (0, import_react.useCallback)((val) => {
    nextId.current = val;
  }, []);
...
function $9cc09df9fd7676be$export$7bbed75feba39706(props) {
  ...
  let dragging = (0, import_react.useRef)(false);
  let prevPosition = (0, import_react.useRef)(0);
  let handlers = (0, import_react.useRef)({
    onPositionChange,
    onDrag
  });
...
function $5df64b3807dc15ee$export$d699905dd57c73ca() {
  let [size, setSize] = (0, import_react.useState)(() => $5df64b3807dc15ee$var$getViewportSize());
  (0, import_react.useEffect)(() => {
    let onResize = () => {
      setSize((size2) => {
...
function $ef06256079686ba0$export$f8aeda7b10753fa1(description) {
  let [id, setId] = (0, import_react.useState)(void 0);
  (0, $f0a04ccd8dbdd83b$export$e5c5a5f917a5871c)(() => {
    if (!description)
      return;
...
function $e9faafb641e167db$export$90fc3a17d93f704c(ref, event, handler, options) {
  let handlerRef = (0, import_react.useRef)(handler);
...
//# sourceMappingURL=chunk-7VOPOBX3.js.map
