...
describe('Simulateur réduction générale', function () {
	if (!fr) {
		return
	}
	...
	it('devrait afficher un avertissement pour une rémunération trop élevée', function () {
	...
	it('devrait calculer la réduction générale indépendemment pour chaque mois', function () {
		cy.get(inputSelector).first().type(inputAmount)
	...
	it(
		'devrait inclure la régularisation progressive',
		{
