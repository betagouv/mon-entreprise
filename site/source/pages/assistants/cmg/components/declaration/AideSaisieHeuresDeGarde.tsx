...
export default function AideSaisieHeuresDeGarde() {
	...
	return (
		<>
			<StyledQuestion>
				{t(
					'pages.assistants.cmg.declarations.aise-saisie.heures-de-garde.titre',
					'Nombre d’heures de garde'
				)}
			</StyledQuestion>
			<StyledBody>
				<Trans i18nKey="pages.assistants.cmg.declarations.aise-saisie.heures-de-garde.contenu">
