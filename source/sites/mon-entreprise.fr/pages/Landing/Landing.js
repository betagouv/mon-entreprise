		...
		<div className="app-content">
			...
			<section className="ui__ full-width light-bg center-flex">
				<Link
					...
					<h3>
						<T k="landing.choix1">Créer une entreprise</T>
					</h3>
					<p className="ui__ notice" css="flex: 1">
						Un accompagnement au choix du statut et la liste complète des
						démarches de création
					</p>
					<div className="ui__ small simple button">Commencer</div>
				</Link>
				<Link
					className="ui__ interactive card box "
					...
					<div className="ui__ big box-icon">{emoji('💶')}</div>
					<h3>
						<T k="landing.choix2">Gérer mon activité</T>
					</h3>
					<p className="ui__ notice" css="flex: 1">
				...
				<Link
					...
					<div className="ui__ big box-icon">{emoji('🙋')}</div>
					<h3>
						<T k="landing.choix3">Que dois-je déclarer ?</T>
					</h3>
					<p className="ui__ notice" css="flex: 1">
