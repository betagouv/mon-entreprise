...
export function impôtSociétéConfig({ t, sitePaths }: SimulatorsDataParams) {
	return config({
		...
		meta: {
			title: t('pages.simulateurs.impot-société.meta.title', 'Impôt sur les sociétés'),
			description: t(
		...
		shortName: t('pages.simulateurs.impot-société.meta.title', 'Impôt sur les sociétés'),
		title: t(
