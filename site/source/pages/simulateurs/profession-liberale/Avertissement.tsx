	...
	return (
		<Ul>
			<DarkLi>
				{professionnelles ? (
					<Trans
						i18nKey="pages.simulateurs.profession-liberale.warning.général.spécifique"
						shouldUnescape={true}
					>
					...
					<Trans i18nKey="pages.simulateurs.profession-liberale.warning.général.générique">
			...
			<DarkLi>
				{professionnelles ? (
					<Trans i18nKey="pages.simulateurs.profession-liberale.warning.cotisations-ordinales.spécifique">
					...
					<Trans i18nKey="pages.simulateurs.profession-liberale.warning.cotisations-ordinales.générique">
