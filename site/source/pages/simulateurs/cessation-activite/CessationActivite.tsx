...
import { CessationActivitéGoals } from '@/pages/simulateurs/cessation-activite/Goals'
...
const nextSteps = ['independant'] satisfies SimulateurId[]

export const CessationActivitéSimulation = () => {
	const id = 'cessation-activite'
	...
	const externalLinks = [
		{
			...
			title: t(
				'pages.simulateurs.cessation-activite.externalLinks.1.title',
				'Le service Cessation d’activité'
			),
			description: t(
				'pages.simulateurs.cessation-activite.externalLinks.1.description',
	...
	const basePath = useSimulatorsData().independant
				...
				>
					<SimulateurWarning
						...
						informationsComplémentaires={
							<Trans i18nKey="pages.simulateurs.cessation-activite.warning">
								<Body>
									Vous êtes travailleur independant ou travailleuse independante
