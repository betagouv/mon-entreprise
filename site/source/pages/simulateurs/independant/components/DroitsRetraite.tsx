...
export default function DroitsRetraite() {
	...
	return (
		<section>
			<H2>
				{t(
					'pages.simulateurs.independant.explications.retraite.titre',
					'Votre retraite'
				)}
			</H2>

			<Trans i18nKey="pages.simulateurs.independant.explications.retraite.droits">
				...
				<Condition expression={{ '=': [exonérationRetraiteActive, 'non'] }}>
					<Condition expression="independant . cotisations et contributions . cotisations . exonérations . Acre">
						...
						<Condition
							expression={{
								'une de ces conditions': [
									...
									'independant . profession libérale . CNAVPL',
								],
							}}
						>
							...
							<WhenNotApplicable dottedName="protection sociale . retraite . complémentaire . Cipav">
								<Li>
									...
									<WhenNotApplicable dottedName="protection sociale . retraite . complémentaire . RCI">
										...
										<WhenApplicable dottedName="independant . profession libérale">
											<SmallBody>
