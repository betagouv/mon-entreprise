		...
		<FromBottom>
			<Message>
				...
				<WhenApplicable dottedName="independant . cotisations et contributions . début activité">
					<Intro>
						{t(
							'pages.simulateurs.independant.explications.cotisations.forfaitaires',
							'Cotisations forfaitaires :'
						)}{' '}
						<Value expression="independant . cotisations et contributions . début activité" />
					</Intro>
				</WhenApplicable>
				<Condition expression="independant . cotisations et contributions . cotisations . exonérations . invalidité">
					<Body>
						<em>
							{t(
								'pages.simulateurs.independant.explications.cotisations.invalidité',
				...
				{rule.rawNode.références && (
					<>
						...
						>
							{t(
								'pages.simulateurs.independant.explications.cotisations.fiche',
