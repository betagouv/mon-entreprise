...
import RuleTitleWithRésumé from '@/components/EngineValue/RuleTitleWithResume'
...
const net = 'salarie . rémunération . net . à payer avant impôt'
const netHabituel = 'salarie . activité partielle . net habituel'
const totalEntreprise = 'salarie . coût total employeur'
...
export default function ComparaisonTable() {
	...
	const caption = t(
		'pages.simulateurs.activite-partielle.comparaison.caption',
		"Tableau indiquant le salaire net et le coût pour l'employeur avec ou sans activité partielle."
	)
	const headerHabituellement = t(
		'pages.simulateurs.activite-partielle.comparaison.habituellement',
		'Habituellement'
	)
	const headerActivitéPartielle = t(
		'pages.simulateurs.activite-partielle.comparaison.activite-partielle',
					...
					<tbody>
						<tr>
							...
							<td>
								...
								<RightAlignedParagraph data-test-id="comparaison-net">
									<Trans i18nKey="pages.simulateurs.activite-partielle.comparaison.net">
						...
						<tr>
							...
							<td>
								<ValueTotal />
								<RightAlignedParagraph>
									<Trans i18nKey="pages.simulateurs.activite-partielle.comparaison.total">
