...
import { configPharmacien } from '../profession-liberale/simulationConfig'
...
export function pharmacienConfig({ t, sitePaths }: SimulatorsDataParams) {
	return config({
		...
		pathId: 'simulateurs.profession-liberale.pharmacien',
		...
		path: sitePaths.simulateurs['profession-liberale'].pharmacien,
