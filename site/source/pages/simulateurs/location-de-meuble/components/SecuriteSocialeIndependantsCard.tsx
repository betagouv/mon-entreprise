...
import { Li, Link, StatusCard, Strong, Ul } from '@/design-system/index'

import {
	estApplicableSurRecettesCourteDurée,
	getStatus,
	StatutApplicabilité,
} from './StatutApplicabilite'
...
export const SécuritéSocialeIndépendantsCard = ({
	...
	return (
		<StatusCard status={status}>
			...
			<StatusCard.Titre>
				{t(
					'pages.simulateurs.location-de-logement-meublé.régimes.travailleur-independant.libellé',
					'Travailleur independant (hors auto-entrepreneur)'
				)}
			</StatusCard.Titre>
			...
			<StatusCard.Action>
				<Link href="https://www.urssaf.fr">
					{t(
						'pages.simulateurs.location-de-logement-meublé.régimes.travailleur-independant.lien',
