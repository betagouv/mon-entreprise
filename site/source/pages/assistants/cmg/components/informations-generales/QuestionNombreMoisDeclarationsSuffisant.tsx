...
export default function QuestionNombreMoisDéclarationsSuffisant() {
	...
	return (
		<>
			<Question id="mois-declarations-label">
				{t(
					'pages.assistants.cmg.informations-generales.mois-declarations.label',
			...
			<ToggleGroup
				aria-labelledby="mois-declarations-label"
				onChange={onChange}
				value={valeur}
			>
				<StyledRadio value="oui" id="input-mois-declarations-oui">
					{t('Oui')}
				</StyledRadio>
				<StyledRadio value="non" id="input-mois-declarations-non">
					{t('Non')}
				</StyledRadio>
			</ToggleGroup>
		</>
