...
import { Body, H2, Li, Link, Strong, Ul } from '@/design-system/index'
...
export const SeoExplanations = () => {
	...
	return (
		<Trans i18nKey="pages.simulateurs.salarie.seo">
			<section>
				...
				<Body>
					...
					du salarie et qui sont retranchées du salaire « net » perçu par le
					salarie.
				</Body>
				<Body>
				...
				<StyledImage
					...
					alt={t(
						'pages.simulateurs.salarie.alt-image1',
						'Salaire net (perçu par le salarie) est égal à Salaire brut (inscrit dans le contrat de travail) moins cotisations salariales (retraite, csg, etc)'
					)}
				/>
				<Body>
					...
					à partir de la declaration de revenus du salarie. Si ce taux est
			...
			<section>
				...
				<Body>
					...
					rémunération de votre salarie, ainsi que les montants de cotisations
				...
				<Body>
					...
					<RuleLink
						...
						dottedName="salarie . coût total employeur . aides"
					>
						aides différées
					</RuleLink>{' '}
