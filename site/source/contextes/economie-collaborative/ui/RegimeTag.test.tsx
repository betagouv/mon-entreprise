...
import { RegimeCotisation } from '@/contextes/economie-collaborative/index'
import { DesignSystemThemeProvider } from '@/design-system/index'

import { RégimeTag } from './RegimeTag'
...
describe('RégimeTag', () => {
	...
	it("affiche un titre sur l'abréviation pour le libellé complet", () => {
		...
		expect(
			screen.getByTitle('Travailleur independant (hors auto-entrepreneur)')
		).toBeInTheDocument()
		expect(
			screen.getByTitle('Travailleur independant (hors auto-entrepreneur)')
