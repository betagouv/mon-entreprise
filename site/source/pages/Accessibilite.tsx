...
export default function Accessibilité() {
	...
	return (
		<Trans i18nKey="pages.accessibilité">
			...
			<Body>
				Cette page n'est pas une page d'aide, mais une declaration de conformité
				au{' '}
				<abbr
					title={t(
						'accessibility.description',
			...
			<Body>
				Cette declaration d’accessibilité s’applique à{' '}
			...
			<Ul>
				...
				<Li>
					La page "Simulateur de revenus pour salarie" a un taux de conformité
					de 100%.
				</Li>
			</Ul>
			<Body>
			...
			<Body>Néant</Body>
			<H3>Établissement de cette declaration d'accessibilité</H3>{' '}
			<Body>
				Cette declaration d'accessibilité a été établie le 15 mai 2025. Elle a
			...
			<Ul>
				...
				<Li>
					<Link href="/simulateurs/salaire-brut-net">
						Page "Simulateur de revenus pour salarie"
					</Link>
				</Li>
				<Li>
