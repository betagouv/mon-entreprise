...
import { Body, Button, H2, Spacing, Strong } from '@/design-system/index'
	...
	return (
		<FromBottom>
			<div>
				<H2 as="h2">
					{t(
						'pages.simulateurs.independant.explications.cotisations.régularisation.titre',
						'Comment fonctionne la régularisation des cotisations provisionnelles ?'
					)}
				</H2>
				<Trans i18nKey="pages.simulateurs.independant.explications.cotisations.régularisation.description">
					<Body>
