...
import { Body, Emoji, Link, Message, SmallBody, Strong } from '@/design-system/index'
...
import ExplicationsSalaire from '@/pages/simulateurs/salarie/components/Explications'
...
const nextSteps = ['activite-partielle'] satisfies SimulateurId[]
	...
	const externalLinks = [
		{
			...
			title: t(
				'pages.simulateurs.salarie.externalLinks.1.title',
				'Code du travail numérique'
			),
			description: t(
				'pages.simulateurs.salarie.externalLinks.1.description',
			...
			ariaLabel: t(
				'pages.simulateurs.salarie.externalLinks.1.ariaLabel',
								...
								!document.referrer?.includes('code.travail.gouv.fr') && (
									<WhenNotAlreadyDefined dottedName="entreprise . catégorie juridique">
										<FadeIn>
											...
											>
												<SmallBody>
													<Trans i18nKey="pages.simulateurs.salarie.SASU">
				...
				>
					<SimulateurWarning
						...
						informationsComplémentaires={
							<>
								<Body>
									<Trans i18nKey="pages.simulateurs.salarie.warning.réformes">
								...
								<Body>
									<Trans i18nKey="pages.simulateurs.salarie.warning.général">
