...
export default function ÉtapesPourReproduireUnCalcul({ mode }: Props) {
	...
	return (
		<Ol>
			<Li>
				<Body>
					<Trans i18nKey="pages.développeur.components.StepByStep.1">
						<Strong>
			...
			<Li>
				<Body>
					<Trans i18nKey="pages.développeur.components.StepByStep.2">
						<Strong>
			...
			<Li>
				<Body>
					<Trans i18nKey="pages.développeur.components.StepByStep.3">
						<Strong>
			...
			{mode === 'npm' && (
				<Li>
					<Body>
						<Trans i18nKey="pages.développeur.components.StepByStep.4-npm">
							<Strong>
			...
			{mode === 'api' && (
				<Li>
					<Body>
						<Trans i18nKey="pages.développeur.components.StepByStep.4-api">
							<Strong>
			...
			<Li>
				<Body>
					<Trans i18nKey="pages.développeur.components.StepByStep.5">
						<Strong>
