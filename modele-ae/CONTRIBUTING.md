...
contenant les règles elles-mêmes (dans le dossier `modele-ae`)
...
### Développement de modele-ae et de mon-entreprise

Pour développer les règles de `modele-ae` et tester en temps réel sur les simulateurs de mon-entreprise, il vous faut lancer la commande suivantes : 
...
Lors de toute modification du package `modele-ae`, il est nécessaire de :
