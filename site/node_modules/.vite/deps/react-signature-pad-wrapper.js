...
function i(t2, e, n2) {
  ...
  return function(t3, e2, n3) {
    var r3, i2 = n3 || {}, o2 = i2.noTrailing, a = void 0 !== o2 && o2, s = i2.noLeading, u = void 0 !== s && s, c = i2.debounceMode, p = void 0 === c ? void 0 : c, d = false, f = 0;
    function h() {
      r3 && clearTimeout(r3);
    }
    function l() {
      for (var n4 = arguments.length, i3 = new Array(n4), o3 = 0; o3 < n4; o3++)
        i3[o3] = arguments[o3];
      var s2 = this, c2 = Date.now() - f;
      function l2() {
        f = Date.now(), e2.apply(s2, i3);
      }
      function g() {
        r3 = void 0;
      }
      d || (u || !p || r3 || l2(), h(), void 0 === p && c2 > t3 ? u ? (f = Date.now(), a || (r3 = setTimeout(p ? g : l2, t3))) : l2() : true !== a && (r3 = setTimeout(p ? g : l2, void 0 === p ? t3 - c2 : t3)));
    }
    return l.cancel = function(t4) {
      var e3 = (t4 || {}).upcomingOnly, n4 = void 0 !== e3 && e3;
      h(), d = !n4;
    }, l;
  }(t2, e, { debounceMode: false !== (void 0 !== r2 && r2) });
}
var o = function(o2) {
  function a(e) {
    var n2 = o2.call(this, e) || this;
    return n2.canvasRef = t.createRef(), n2.state = { canvasWidth: 0, canvasHeight: 0 }, n2.callResizeHandler = i(n2.props.debounceInterval, n2.handleResize.bind(n2)), n2;
  }
  return function(t2, e) {
    ...
    n(t2, e), t2.prototype = null === e ? Object.create(e) : (r2.prototype = e.prototype, new r2());
    ...
    var e = Math.max(window.devicePixelRatio || 1, 1), n2 = (this.props.width || t2.offsetWidth) * e, r2 = (this.props.height || t2.offsetHeight) * e, i2 = this.state, o3 = i2.canvasWidth, a2 = i2.canvasHeight;
    if (n2 !== o3 || r2 !== a2) {
      var s;
      this.props.redrawOnResize && this.signaturePad && (s = this.signaturePad.toDataURL()), t2.width = n2, t2.height = r2, this.setState({ canvasWidth: n2, canvasHeight: r2 });
    ...
    return t.createElement("canvas", r({ "data-testid": "canvas-element", ref: this.canvasRef }, e));
