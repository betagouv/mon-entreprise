...
import { type RéponseManquante } from '@/contextes/economie-collaborative/index'
import { Body, H3, Li, Message, Spacing, Ul } from '@/design-system/index'

import { getLibelléInfoManquante } from '../getLibelleInfoManquante'
import { ComparateurRégimesCards } from './ComparateurRegimesCards'
