...
const coutTotalSelector = 'input[id="salarie___coût_total_employeur-input"]'
const salaireBrutSelector = 'input[id="salarie___contrat___salaire_brut-input"]'
const salaireNetSelector =
	'input[id="salarie___rémunération___net___à_payer_avant_impôt-input"]'
const salaireNetApresImpot =
	'input[id="salarie___rémunération___net___payé_après_impôt-input"]'
